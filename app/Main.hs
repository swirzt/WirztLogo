...
runProgramC e args = case files args of
  []   -> putMVar (out e)
    $ Show "No se ingresó ningun archivo para el modo de Compilado."
  [_]  -> putMVar (out e)
    $ Show
      "Se debe ingresar al menos 2 archivos, el último es el nombre del archivo a guardar."
...
-- Recibe un estado y un archivo, llama a la función toFile con la extensión apropiada
...
-- Corre una lista de Comandos con un único entorno hasta evaluar todo
